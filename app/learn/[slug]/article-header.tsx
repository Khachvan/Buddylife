...
const copy = {
  hy: { links: [["/features", "Հնարավորություններ"], ["/pet-parents", "Կենդանատերերին"], ["/for-business", "Բիզնեսին"], ["/learn", "Սովորել"]], join: "Միանալ մեզ", home: "BuddyLife գլխավոր էջ", nav: "Գլխավոր նավարկում", language: "Փոխել լեզուն", menu: "Բացել ընտրացանկը", close: "Փակել ընտրացանկը" },
  ru: { links: [["/features", "Возможности"], ["/pet-parents", "Владельцам"], ["/for-business", "Бизнесу"], ["/learn", "Материалы"]], join: "Присоединиться", home: "Главная BuddyLife", nav: "Основная навигация", language: "Сменить язык", menu: "Открыть меню", close: "Закрыть меню" },
  en: { links: [["/features", "Features"], ["/pet-parents", "Pet parents"], ["/for-business", "For business"], ["/learn", "Learn"]], join: "Join us", home: "BuddyLife home", nav: "Main navigation", language: "Change language", menu: "Open menu", close: "Close menu" },
  fa: { links: [["/features", "امکانات"], ["/pet-parents", "برای سرپرستان حیوانات"], ["/for-business", "برای کسب‌وکارها"], ["/learn", "آموزش"]], join: "به ما بپیوندید", home: "صفحه اصلی BuddyLife", nav: "پیمایش اصلی", language: "تغییر زبان", menu: "باز کردن منو", close: "بستن منو" },
} as const;
...
export default function ArticleHeader({ lang, slug }: { lang: Lang; slug: string }) {
  ...
  useEffect(() => { localStorage.setItem("buddylife-lang", lang); document.documentElement.lang = lang; document.documentElement.dir = lang === "fa" ? "rtl" : "ltr"; }, [lang]);
  useEffect(() => {
