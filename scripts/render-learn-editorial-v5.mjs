...
const sourceDir = path.join(root, "design-sources", "learn-editorial-v5");
const publicDir = path.join(root, "public");
const logoPath = path.join(publicDir, "buddylife-logo-clean.png");
...
for (const slug of slugs) {
  ...
  const output = path.join(publicDir, `learn-${slug}-editorial-v5.jpg`);
  await sharp(source)
